                                ...
                                <form @submit.prevent="handleSubmit">
                                    <div class="space-y-5">
                                        ...
                                        <div>
                                            ...
                                            <input v-model="ten_dang_nhap" type="text" id="ten_dang_nhap"
                                                name="ten_dang_nhap" placeholder="Nhập tên đăng nhập ..." required
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                <input v-model="mat_khau" :type="showPassword ? 'text' : 'password'"
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <router-link to="/reset-password"
                                                class="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400">Quên
